...
function popularCanton() {
    ...
    document.querySelector('#txtHiddenProvincia').value = document.querySelector('#inputProvincia').value;
...
function popular() {
    document.querySelector('#txtHiddenDistrito').value = document.querySelector('#inputDistrito').value
}
