function RoomTypeCreate() {
    ...
    this.formId = '#registroTipoHabitacion'
    this.formName = 'registroTipoHabitacion'
    ...
    this.Create = function () {
        var elementCollection = document.getElementsByName('btnPetsAllowed');
        var elementsArray = Array.prototype.slice.call(elementCollection, 0);
        var info = (elementsArray.filter(x => x.checked))
        var value = info[0];
        document.querySelector('#txtPetsAllowed').value = value.value;
        ...
        let tHabPrice = customerData.Price;
        var price = tHabPrice.replace(/,/g, '.');
...
$(document).ready(function () {
    ...
    var vtype = new RoomTypeCreate();
    KTFormControls.init(vtype.getFormValidationRules());
