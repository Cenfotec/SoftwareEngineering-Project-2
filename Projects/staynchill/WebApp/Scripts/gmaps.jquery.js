(function($) {
  ...
  Gmaps.prototype.getMarkerLabel = function(element) {
    var _label = $(element).attr('data-price');
    if (_label === undefined) {
      return false;
    }
    return _label;
  ...
  Gmaps.prototype.addMarker = function(settings) {
    ...
    options.label = {text: settings.label, color: "#ffffff"}
