const selectProvincias = document.querySelector('#inputProvincia');
const selectCantones = document.querySelector('#inputCanton');
const selectDistrito = document.querySelector('#inputDistrito');
const selectStars = document.querySelector('#inputStars');

const optionProvincias = document.querySelector('#optionProvincias');
const optionCantones = document.querySelector('#optionCantones');
const optionStars = document.querySelector('#optionStars');
...
for (let i = 0; i < stars.length; i++) {
    ...
    opt.value = stars[i];
    selectStars.appendChild(opt);
}


function popularCanton() {

    document.querySelector('#txtHProvincia').value = document.querySelector('#inputProvincia').value;

    $("#inputCanton option").each(function () {
        if (this.value !== '') {
            $(this).remove();
        }
    });
...
function popularDistrito() {
    ...
    document.querySelector('#txtHCanton').value = document.querySelector('#inputCanton').value
...
function popular() {
    document.querySelector('#txtHDistrito').value = document.querySelector('#inputDistrito').value
}

selectProvincias.addEventListener('change', popularCanton);
selectCantones.addEventListener('change', popularDistrito);
selectDistrito.addEventListener('change', popular);